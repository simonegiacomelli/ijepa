...
def _load_cpu_vit_huge(patch_size, num_classes, load_path):
...
def load_cpu_IN22k_vit_h_14_900e():
    return _load_cpu_vit_huge(14, 22000, '/home/simone/Downloads/ijepa/IN22K-vit.h.14-900e.pth.tar')


def load_cpu_IN1k_vit_h_14_300e():
    return _load_cpu_vit_huge(14, 1000, '/home/simone/Downloads/ijepa/IN1K-vit.h.14-300e.pth.tar')
